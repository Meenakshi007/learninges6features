    ...
    _createClass(ObjectFormatter, null, [{
        ...
        value: function format(obj) {
            ...
            if (obj) {
                ...
                formattedMessage = formattedMessage.substr(START_POS, formattedMessage.length - NO_OF_TRAIL_CHAR);
            }
...
var Order = function () {
    function Order(orderId, orderDate, amount) {
...
var _customer = __webpack_require__(86);

var _arrowFunction = __webpack_require__(119);

var _withoutPromise = __webpack_require__(124);

var _withPromise = __webpack_require__(123);

var PromiseWorkers = _interopRequireWildcard(_withPromise);

var _order2 = __webpack_require__(87);
...
var customerCsvString = '10, northwind, NCR, 234, true';

//import { ValueAnalyzer } from './valueAnalyzer';

var anotherCustomer = _customer.Customer.createCustomer(customerCsvString); //creates instace of customer

anotherCustomer.addOrder(new _order2.Order(1, new Date(), 1200));
anotherCustomer.addOrder(new _order2.Order(2, new Date(), 1300));
anotherCustomer.addOrder(new _order2.Order(3, new Date(), 1000));
anotherCustomer.addOrder(new _order2.Order(4, new Date(), 1100));
...
var dataProcessor = new _arrowFunction.DataProcessor();
...
var worker1 = new _withoutPromise.HeavyWorker();
var worker2 = new _withoutPromise.HeavyWorker2();
...
var workerWithPromise1 = new PromiseWorkers.HeavyWorker();
var workerWithPromise2 = new PromiseWorkers.HeavyWorker2();
var input = 200;

Promise.all([workerWithPromise1.process(input), workerWithPromise2.process(input)]).then( // then is called after both promise return, it accepts 2 callbacks (one for success, one for failure)
function (data) {
    return console.log('Both completed successfully' + JSON.stringify(data));
}, function (error) {
...
var InternetCustomer = function (_Customer) {
    ...
    function InternetCustomer(id, name, address, credir, status, blogUrl) {
    ...
    _createClass(InternetCustomer, [{
        key: 'format',
        value: function format() {
            var formattedMessage = _formatutils.ObjectFormatter.format(this).toLowerCase();
            return formattedMessage;
        }
    }]);
...
processOrder = new Proxy(processOrder, { // proxying the function call
    apply: function apply(target, currentHandler, args) {
        // target = original funct, currentHandler = for proxying object
        var alreadyProcessedOrder = ['ORD1001', 'ORD1002', 'ORD1003'];
    ...
    _createClass(HeavyWorker, [{
        ...
        value: function process(input) {
            var workerPromise = new Promise(function (resolve, reject) {
                setTimeout(function () {
                    var status = input >= VALID_VALUE ? SUCCESS : FAILURE;
                    if (status === SUCCESS) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(116), __webpack_require__(307)(module)))
