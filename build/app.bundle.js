...
var internetCustomer = new _internetCustomer.InternetCustomer(10, 'northwind', 'delhi', 1200, true, 'http://google.com' // create instance of internetcustomer
);

console.log(internetCustomer.format());
console.log(internetCustomer instanceof _internetCustomer.InternetCustomer);

var customerCsvString = '10, northwind, NCR, 234, true';
var anotherCustomer = _internetCustomer.InternetCustomer.createCustomer(customerCsvString); //creates instace of customer
